...
@section('content')
    ...
    <form action="{{ route('admin.commandes.store') }}" method="POST" class="space-y-6" id="commande-form">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="datetime-local" name="commande_date" id="commande_date" value="{{ old('commande_date', now()->format('Y-m-d\TH:i')) }}" class="mt-1 focus:ring-pink-500 focus:border-pink-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
        </div>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg p-4 mt-6">
            ...
            <div class="mt-6 flex justify-end">
                <div class="text-right">
                    ...
                    <div class="text-lg font-medium text-gray-900" id="total-commande">0.00 €</div>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addEventListeners(document.querySelector('.produit-item'));
